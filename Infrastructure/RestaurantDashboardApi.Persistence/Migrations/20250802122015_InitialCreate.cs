    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "concurrency-waiter", "Waiter", "WAITER" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "concurrency-restaurantcase", "RestaurantCase", "RESTAURANTCASE" },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "concurrency-systemadmin", "SystemAdmin", "SYSTEMADMIN" }
                });
